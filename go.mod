module github.com/nimbess/nimbess-agent
...
require (
	...
	github.com/nimbess/stargazer v0.0.0-20190828220501-0cd7a98f96df
	...
	k8s.io/apiextensions-apiserver v0.0.0-20190828120306-a711da75262f // indirect
	k8s.io/apimachinery v0.0.0-20190828114620-4147c925140e
	k8s.io/apiserver v0.0.0-20190828160019-ff4d6509a8ae // indirect
